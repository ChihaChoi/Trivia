...
class ResultsAnswer extends Component {
  ...
  render() {
    return (
      <div
        className={
          (this.props.correct ? "results__container--correct " : ``) +
          "results__container"
        }
      >
        <div
        ...
        />
        {this.props.correct ? <div className="results__plusOne">+1</div> : ""}
        <div className="results__players">
          ...
          {this.props.players.map((ele, i) => {
            return (
              <div
                className={
                  (ele === window.playerName
                    ? "results__players__player--active"
